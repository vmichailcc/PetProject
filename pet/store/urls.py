...
from .views import ProductView, ProductDetailView, StoreApiView, CommentApiView, OrderApiView, DashboardView,\
    ProductDetailApiView, OrderDetailApiView
...
product_router.register('', ProductDetailApiView, basename='store_router')
...
order_detail_router.register('', OrderDetailApiView, basename='order_router')
